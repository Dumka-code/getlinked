...
function NavBar() {
  ...
  return (
    <header className={`h-22 sticky top-0 z-40 backdrop-filter backdrop-blur-lg bg-opacity-10`}>
           ...
           <div className="hidden md:flex items-center">
            <nav>
              <ul className="flex items-center gap-x-8 font-bold">
                ...
                <li><Link to="footer" smooth={true} duration={500} className="hover:text-sky-500 dark:hover:text-sky-400">Contact</Link></li>
...
<div className='fixed top-0 right-0 z-50'  onClick={handleMenuClick}>
  ...
  <ul className="flex flex-col gap-y-5">
                ...
                <li><Link to="footer" smooth={true} duration={500} className="hover:text-sky-500 dark:hover:text-sky-400 text-base font-bold text-slate-400">Contact</Link></li>
                </ul>
  </div>
</div>
